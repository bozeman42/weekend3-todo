...
router.get('/',function(req,res){
  ...
  pool.connect(function(errorConnectingToDb, db, done){
    ...
    if(errorConnectingToDb) {
      ...
      var queryText = 'SELECT * FROM "todo_list" ORDER BY "todo_complete", "todo_due", "todo_id"';
...
router.post('/', function(req,res){
  ...
  pool.connect(function(errorConnectingToDb,db,done){
    ...
    if(errorConnectingToDb){
      ...
      var queryText = 'INSERT INTO "todo_list" ("todo_text","todo_due") VALUES ($1,$2)';
      db.query(queryText,[newTodo.todo_text,newTodo.todo_due],function(errorQueryingDb,result) {
        if (errorQueryingDb) {
