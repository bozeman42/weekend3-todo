...
function appendTodo(todo,id){
  ...
  var dueDate = new Date(todo.todo_duedate+"T23:59:59-0500");
  console.log(dueDate);
  var today = new Date();
  if (dueDate < today) {
  ...
  $itemText = $('<div class="itemText"><span class="dueDate">Due: ' + dueDate.toDateString() + '</span><br><span class="todoTextSpan">' + todo.todo_text+'</span></div>');
